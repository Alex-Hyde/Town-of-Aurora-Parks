...
$PopulateStorageHistory = {
    ...
    elseif (($Object.Value.Version -eq 9) -or  ($Object.Value.Version -eq 10))
    {
        $Object.Value.PSObject.TypeNames.Insert( 1, "Microsoft.Windows.StorageManagement.StorageHistory_v10" )
...
$PopulateStorageHistoryAggregate = {
    ...
    if ($AggregateObject.Value.Version -eq 0)
    {
        ...
        elseif (($Object.Value.Version -eq 9) -or  ($Object.Value.Version -eq 10))
        {
            $AggregateObject.Value.PSObject.TypeNames.Insert( 1, "Microsoft.Windows.StorageManagement.StorageHistoryAggregate_v10" )
        }
